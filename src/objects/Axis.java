...
public class Axis extends Solid {
    ...
    public Axis(){
        ...
        getvB().add(new Vertex(new Point3D(10, 0, 0), new Col(255, 0, 0)));

        // Os Y (zelená)
        getvB().add(new Vertex(new Point3D(0, 0, 0), new Col(0, 255, 0)));
        getvB().add(new Vertex(new Point3D(0, 10, 0), new Col(0, 255, 0)));

        // Os Z (modrá)
        getvB().add(new Vertex(new Point3D(0, 0, 0), new Col(0, 0, 255)));
        getvB().add(new Vertex(new Point3D(0, 0, 10), new Col(0, 0, 255)));
